...
export type DateType = Date | number | string | moment.Moment;
...
export type TimelineOptionsGroupOrderType = string | (() => void) | any; // TODO
...
export class DataView<T extends DataItem | DataGroup> {
  length: number;
  constructor(items: T[] | DataSet<T>, options: {});
}
